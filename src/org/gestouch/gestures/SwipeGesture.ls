package org.gestouch.gestures
{
	...
	{
		private static const ANGLE:Number = 40 * Math.PI / 180;
		private static const MAX_DURATION:uint = 500;
		private static const MIN_OFFSET:Number = Platform.getDPI() / 6;
		 ...
		 * Default value is <code>Platform.getDPI() / 6</code> and generally should not
		 * be changed.
		 */
