...
//		public var lastMove:Point;
		...
		public function gestouch_internal_updateLocation(x:Number, y:Number, time:uint):Boolean
		{
			...
			{
				gestouch_internal_setLocation(x, y, time);
			}
		...
		public function gestouch_internal_setTime(value:uint):void
		{
			_time = value;
		}
		...
		public function gestouch_internal_setBeginTime(value:uint):void
		{
			_beginTime = value;
		}
